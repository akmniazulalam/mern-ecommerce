...
export const AuthProvider = ({ children }) => {
  // context create korar porer step hocche provider banano. context je create korechi setar moddhe primarily kichui thakena. provider er maddhome sei context ba container ba box er moddhe data dhukiye erpor puro app ke ei provider er moddhe wrap kore puro app e provide kore dewa hoy. eta ekta wrapping container. jehetu wrapping container tai children thakbe etar. ar ei children tai hocche app.jsx. etar naam o oi context create korar variable er motoi.
